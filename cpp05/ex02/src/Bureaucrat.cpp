...
{
	return "\033[31;3mguy grade is too high\033[0m";
}

const char *Bureaucrat::GradeTooLowException::what() const throw()
{
	return "\033[31;3mguy grade is too low\033[0m";
}
...
void Bureaucrat::executeForm(AForm const & form) const
{
	try {
		...
		std::cout << "\033[31;3m" << this->_name << " couldn't execute " << form.getName() << " because " << e.what() << std::endl;
		throw;
	}
}